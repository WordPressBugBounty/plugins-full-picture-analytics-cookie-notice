...
if ( ! empty( $this->iframes_settings['auto_rules'] ) ) {

    foreach ( $this->iframes_settings['auto_rules'] as $source ) {
        switch ( $source ) {
            case 'youtube':
                $iframeblock_rules[] = array(
                    'name'          => 'youtube.com',
...
if ( ! empty( $this->iframes_settings['manual_rules'] ) ) {
    $iframeblock_rules = array_merge( $iframeblock_rules, $this->iframes_settings['manual_rules'] );
}
