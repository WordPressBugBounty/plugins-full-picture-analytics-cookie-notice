...
class Fupi_CLAR_admin {
    ...
    private function add_actions_and_filters(){
        add_action( 'fupi_register_setting_clar', array( $this, 'register_module_settings' ) );
        add_filter( 'fupi_clar_add_fields_settings', array( $this, 'add_fields_settings' ), 10, 1 );
        add_filter( 'fupi_clar_get_faq_data', array( $this, 'get_faq_data' ), 10, 1 );
    ...
    public function register_module_settings(){
        register_setting( 'fupi_clar', 'fupi_clar', array( 'sanitize_callback' => array( $this, 'sanitize_fields' ) ) );
    }

    public function sanitize_fields( $input ){
        
        include 'clar-sanitize.php';
