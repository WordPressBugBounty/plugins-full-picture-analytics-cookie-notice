...
// ?>
    <div id="fupi_top_nav" class="top_menu_section"><?php 
        ...
        $top_nav = '
            ...
            <a class="fupi_top_nav_link" href="https://wpfullpicture.com/release/wp-full-picture-update-9-1-0/" target="_blank">' . esc_html__('What\'s new in v9.1', 'full-picture-analytics-cookie-notice') . '</a>';
