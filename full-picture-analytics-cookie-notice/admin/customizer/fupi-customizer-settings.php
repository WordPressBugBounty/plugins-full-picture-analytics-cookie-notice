    ...
    class FUPI_Customize_Pure_HTML extends WP_Customize_Control {
        ...
        public function render_content() {
			...
			<span class="customize-inside-control-row">
				<img class="fupi_preview_img fupi_opt_in_out_preview fupi_active" src="' . FUPI_URL . 'admin/customizer/imgs/notice-optin.png"/>
			...
			<span class="customize-inside-control-row">
				<img class="fupi_preview_img fupi_notify_preview" src="' . FUPI_URL . 'admin/customizer/imgs/notice-inform.png"/>
