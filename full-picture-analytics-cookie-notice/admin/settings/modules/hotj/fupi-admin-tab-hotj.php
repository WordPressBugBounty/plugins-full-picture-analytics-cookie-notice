...
if ( $this->cook_enabled ){
	$opt_fields = array(
		array(
			...
			<p>' . esc_html__( 'When you enable this option, this tracking tool will load without waiting for user consent - even in countries where visitors may be tracked only after they agree to tracking.', 'full-picture-analytics-cookie-notice' ) . '</p>
