...
if ( ! current_user_can('manage_options') && ! empty( $this->main ) && ! empty( $this->main['extra_users_2'] ) ) {
	$clean_data['extra_users_2'] = $this->main['extra_users_2'];
}
