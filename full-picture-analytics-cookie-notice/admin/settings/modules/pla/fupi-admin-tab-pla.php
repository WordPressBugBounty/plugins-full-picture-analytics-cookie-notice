...
$sections = array_merge( $sections, $reports_section );
...
$sections = array_merge( $sections, array(
	...
	array(
		...
		'fields' => array(
			...
			array(
				'type'	 			=> 'text',
				'label' 			=> esc_html__( 'Track how many people use ad blockers', 'full-picture-analytics-cookie-notice' ),
				'field_id' 			=> 'detect_adblock_2',
				'placeholder'		=> esc_html__('Goal name, e.g. "Uses an ad blocker"', 'full-picture-analytics-cookie-notice'),
				'option_arr_id'		=> $option_arr_id,
				'label_for' 		=> $option_arr_id . '[detect_adblock_2]',
				'must_have'			=> 'pro',
				'el_class'			=> 'fupi_condition',
				'el_data_target'	=> 'fupi_adblock_test_cond',
				...
				'popup2'			=> '<p style="color: #e47d00">' . esc_html__('It is best to use this option on proxied or self-hosted installations of Plausible. See the "Installation" section for more details. Otherwise, Plausible will be blocked by some ad blockers, which this function is trying to detect.','full-picture-analytics-cookie-notice' ) . '</p>',
			),
				array(
					'type'	 			=> 'toggle',
					'label' 			=> esc_html__( 'Check adblock usage once per session instead of on every page', 'full-picture-analytics-cookie-notice' ),
					'field_id' 			=> 'detect_adblock_per_session',
					'option_arr_id'		=> $option_arr_id,
					'class'				=> 'fupi_sub fupi_adblock_test_cond fupi_disabled',
					'must_have'			=> 'pro',
					'popup'				=> esc_html__( 'Recommended to minimize the number of events sent to Plausible.', 'full-picture-analytics-cookie-notice'),
				),
			array(
				'type'	 			=> 'text',
