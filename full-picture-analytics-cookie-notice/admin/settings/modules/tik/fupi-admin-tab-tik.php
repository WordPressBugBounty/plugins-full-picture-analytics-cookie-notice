...
$basic_fields = array(
	array(
		...
		'under field'		=> '<p>' . sprintf( esc_html__('Learn %1$swhere to get pixel ID from%2$s.','full-picture-analytics-cookie-notice'), '<a href="https://wpfullpicture.com/support/documentation/how-to-install-tiktok-pixel/?utm_source=fp_admin&utm_medium=referral&utm_campaign=settings_link" target="_blank">', '</a>') . '</p>',
	),
);
	...
	array(
		...
		'fields' => array(
			array(
				...
				'option_arr_id'		=> $option_arr_id,
				'popup2'			=> '<p style="color: #e47d00;">' . esc_html__( 'When this option is enabled, all clicks on email and phone links will be tracked and sent to TikTok. However, due to TikToks tracking limitations, the event will NOT contain information WHICH link was clicked.', 'full-picture-analytics-cookie-notice' ) . '</p>',
			),
			array(
				'type'	 			=> 'text',
				...
				'popup2'			=> '<p style="color: #e47d00;">' . esc_html__( 'When this option is enabled, all downloads of files in the provided formats will be tracked and sent to TikTok. However, due to TikToks tracking limitations, the event will NOT contain information WHICH file was downloaded.', 'full-picture-analytics-cookie-notice' ) . '</p>',
			),
			array(
				'type'	 			=> 'r3',
				...
				'popup2'			=> '<h3>' . esc_html__( 'How to fill in these fields', 'full-picture-analytics-cookie-notice' ) . '</h3>
					...
					<p style="color: #e47d00;">' . esc_html__( 'All clicks on page elements will be tracked and sent to TikTok as a single event "ClickButton".', 'full-picture-analytics-cookie-notice' ) . '</p>
