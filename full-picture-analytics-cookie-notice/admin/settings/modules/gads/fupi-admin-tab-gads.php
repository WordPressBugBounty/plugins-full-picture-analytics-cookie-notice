...
$basic_fields = array(
	array(
		...
		'under field'		=> sprintf ( esc_html__( '%1$sHow to get conversion ID%2$s.', 'full-picture-analytics-cookie-notice') , '<a href="https://wpfullpicture.com/support/documentation/how-to-install-google-ads/">', '</a>' ),
	),
	array(
		'type'	 			=> 'toggle',
		...
		'fields' => array(
			array(
				...
				'popup2'			=> '<p>' . esc_html__( 'Conversion event will be sent with cart value and IDs of the purchased items.', 'full-picture-analytics-cookie-notice') . '</p>
					<p>' . sprintf ( esc_html__( 'To get the conversion label, please follow this %1$sshort video tutorial%2$s.', 'full-picture-analytics-cookie-notice') , '<a href="https://www.youtube.com/watch?v=HTSKZAjvRME" class="fupi_vid_link">', ' <i class="dashicons dashicons-youtube"></i></a>' ) . '</p>',
			),
			array(
				'type'	 			=> 'text',
