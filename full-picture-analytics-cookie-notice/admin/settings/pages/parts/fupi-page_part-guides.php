...
if ( $module_path == 'status' ) {
    $file_path = FUPI_PATH . '/admin/settings/pages/parts/fupi-page-part-status-guides.php';
} else {
    $file_path = FUPI_PATH . '/admin/settings/modules/' . $module_path . '/checklist_' . $module_path . '.php';
};
